    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Admin', 'Admin'), ('Speaker', 'Speaker'), ('Listener', 'Listener')], max_length=10)),
        ...
        migrations.AlterField(
            model_name='talk',
            name='speakers',
            field=models.ManyToManyField(related_name='talks', to='home.customuser'),
        ),
    ]
